<main class="seccion">
    ...
    <form class="formulario contenedor" method="POST">
        ...
        <fieldset>
            ...
            <input name="contacto[email]" placeholder="Tu Email" type="email" value="" id="contactar-email">

            <label for="mensaje">Mensaje:</label>
            <textarea id="mensaje" name="contacto[mensaje]"placeholder="Tu Mensaje" ></textarea>
        </fieldset>
